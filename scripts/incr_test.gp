...
# set linetype 1 lc rgb "#FF0000" lw 2 pt 1 # Red
# set linetype 2 lc rgb "#00FF00" lw 2 pt 1 # Lime
# set linetype 3 lc rgb "#FF1493" lw 2 pt 1 # DeepPink
# set linetype 4 lc rgb "#FF4500" lw 2 pt 1
# set linetype 5 lc rgb "#FFD700" lw 2 pt 1
# set linetype 6 lc rgb "#800080" lw 2 pt 1
# set linetype 7 lc rgb "#4B0082" lw 2 pt 1
# set linetype 8 lc rgb "#6A5ACD" lw 2 pt 1
# set linetype 9 lc rgb "#8B4513" lw 2 pt 1
# set linetype 10 lc rgb "#00FF00" lw 2 pt 1
...
if (ARG1 == 1) {
    set ylabel "points"
    plot for [i = ARG4:ARG5] datafile index i - ARG4 using 1:3 with lines lt 9 + i - ARG4 + 1 title sprintf("m = %d", i)
}
if (ARG1 == 2) {
    set ylabel "accuracy"
    plot for [i = ARG4:ARG5] datafile index i - ARG4 using 1:4 with lines lt 18 + i - ARG4 + 1 title sprintf("m = %d", i)
}
if (ARG1 == 3) {
    set ylabel "points / trials"
    plot for [i = ARG4:ARG5] datafile index i - ARG4 using 1:($3 / $2) with lines lt i - ARG4 + 1 title sprintf("m = %d", i)
}
