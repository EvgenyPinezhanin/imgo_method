...
public:
    IBaseFamilyOptProblems(const std::string _familyName = "", size_t _familySize = 0,
        ...
        : IBaseFamilyOptProblems<SearchAreaType, PointType>(_familyName, _familySize, _area, _optimalPoints,
          _optimalValue, _objectiveLipschitzConstant), constraintLipschitzConstants(_constraintLipschitzConstants) {};

    virtual void getConstraintLipschitzConstants(std::vector<std::vector<double>> _constraintLipschitzConstants) const {
