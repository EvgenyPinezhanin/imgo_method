...
const vector<OneDimensionalProblem> sampleTasks{
    ...
    OneDimensionalProblem([] (double x) { return 5.0 * x * x + 3.0 * x - 1.0; },
                          OneDimensionalSearchArea(-2.0, 2.0), vector<double>{ -0.3 }, -1.0, 23.0),

    OneDimensionalProblem([] (double x) { return x * sin(x); },
                          OneDimensionalSearchArea(0.0, 20.0), vector<double>{ 17.336 }, -1.0, 18.955),

    OneDimensionalProblem([] (double x) { return x != 0 ? x * sin(1 / x) : 0.0; },
                          OneDimensionalSearchArea(-0.4, -0.05), vector<double>{ -0.2225 }, -1.0, 6.0 * M_PI)
};
...
const vector<OneDimensionalProblem> testTasks{
    ...
    OneDimensionalProblem([] (double x) { return -(-sin(x) - sin(10.0 / 3.0 * x)); },
                          OneDimensionalSearchArea(2.7, 7.5), vector<double>{ 5.145735 }, 1.899599, 4.29),
    ...
    OneDimensionalProblem(
        [] (double x) {
            ...
            return -sum;
        }, OneDimensionalSearchArea(-10.0, 10.0), vector<double>{ -6.7745761, -0.49139, 5.791785 }, 12.03125, 67.0),

    OneDimensionalProblem([] (double x) { return -(16.0 * x * x - 24.0 * x + 5.0) * exp(-x); },
                          OneDimensionalSearchArea(1.9, 3.9), vector<double>{ 2.868 }, 3.85045, 3.0),

    OneDimensionalProblem([] (double x) { return -(-3.0 * x + 1.4) * sin(18.0 * x); },
                          OneDimensionalSearchArea(0.0, 1.2), vector<double>{ 0.96609 }, 1.48907, 36.0),

    OneDimensionalProblem([] (double x) { return -((x + sin(x)) * exp(-x * x)); },
                          OneDimensionalSearchArea(-10.0, 10.0), vector<double>{ 0.67956 }, 0.824239, 2.5),

    OneDimensionalProblem([] (double x) { return -(-sin(x) - sin(10.0 / 3.0 * x) - log(x) + 0.84 * x - 3.0); },
                          OneDimensionalSearchArea(2.7, 7.5), vector<double>{ 5.19978 }, 1.6013, 6.0),
    ...
    OneDimensionalProblem(
        [] (double x) {
            ...
            return -sum;
        }, OneDimensionalSearchArea(-10.0, 10.0), vector<double>{ -7.0835, -0.8003, 5.48286}, 14.508, 67.0),

    OneDimensionalProblem([] (double x) { return -(-sin(x) - sin(2.0 / 3.0 * x)); },
                          OneDimensionalSearchArea(3.1, 20.4), vector<double>{ 17.039 }, 1.90596, 1.7),

    OneDimensionalProblem([] (double x) { return -(x * sin(x)); },
                          OneDimensionalSearchArea(0.0, 10.0), vector<double>{ 7.9787 }, 7.91673, 11.0),

    OneDimensionalProblem([] (double x) { return -(-2.0 * cos(x) - cos(2.0 * x)); },
                          OneDimensionalSearchArea(-1.57, 6.28), vector<double>{ 2.094, 4.189 }, 1.5, 3.0),

    OneDimensionalProblem([] (double x) { return -(-pow(sin(x), 3) - pow(cos(x), 3)); },
                          OneDimensionalSearchArea(0.0, 6.28), vector<double>{ 3.142, 4.712 }, 1.0, 2.2),

    OneDimensionalProblem(
        [] (double x) {
            return x * x - 1 < 0 ? -(pow(x, 2.0 / 3.0) + pow(-(x * x - 1), 1.0 / 3.0)) :
                           -(pow(x, 2.0 / 3.0) - pow(x * x - 1, 1.0 / 3.0));
        }, OneDimensionalSearchArea(0.001, 0.99), vector<double>{ 0.7071 }, 1.5874, 8.5),

    OneDimensionalProblem([] (double x) { return -(exp(-x) * sin(2 * M_PI * x)); },
                          OneDimensionalSearchArea(0.0, 4.0), vector<double>{ 0.224885 }, 0.788685, 6.5),

    OneDimensionalProblem([] (double x) { return -((-x * x + 5.0 * x - 6.0) / (x * x + 1)); },
                          OneDimensionalSearchArea(-5.0, 5.0), vector<double>{ 2.4142 }, 0.03553, 6.5),

    OneDimensionalProblem([] (double x) { return -(-2.0 * (x - 3) * (x - 3) - exp(- x * x / 2)); },
                          OneDimensionalSearchArea(-3.0, 3.0), vector<double>{ 3.0 }, -7.515924, 85.0),
    ...
    OneDimensionalProblem([] (double x) { return -(x - sin(3.0 * x) + 1.0); },
                          OneDimensionalSearchArea(0.0, 6.5), vector<double>{ 5.87287 }, 7.81567, 4.0),

    OneDimensionalProblem([] (double x) { return -(x - sin(x)) * exp(- x * x); },
                          OneDimensionalSearchArea(-10.0, 10.0), vector<double>{ 1.195137 }, 0.0634905, 1.3)
};
